var Aufgabe9UnterwasserWelt;
(function (Aufgabe9UnterwasserWelt) {
    ...
    function init(_event) {
        ...
        //Fische zeichnen
        for (let i = 0; i < 4; i++) {
            let x = Math.random() * (crc2.canvas.width - 50);
        ...
        //Luftblasen zeichnen
        for (let i = 0; i < 15; i++) {
            let x = Math.random() * (1200 - 50) + 0; //Gibt an, wo auf der x-Achse die Blasen sind. +300 ist eine Konstante Stelle. (600-200) gibt den Bereich an.
            let y = Math.random() * 630; //y-Koordinate: von wo bis wo die Blasen wandern können
            let z = Math.random() * 20; // z lässt Blasen in einer bestimmten Größe entstehen
            drawBubble(x, y, z);
        }
    }
    ...
    function drawBubble(_x, _y, _bubbleSize) {
...
})(Aufgabe9UnterwasserWelt || (Aufgabe9UnterwasserWelt = {}));
